...
```sh
git clone https://github.com/PyMoDAQ/nomad-plugin-sintering.git
cd nomad-plugin-sintering
...
```sh
pip install dist/nomad-plugin-sintering-0.1.0
```
